...
?>
    ...
    <script>  
        $(document).ready(function(){  
            ...
            // document.getElementById('create_date').value = new Date().toDateInputValue();
            // $('#create_date').val(new Date().toDateInputValue());
        ...
        rows.forEach(row => {
            row.addEventListener('click', () => {
                ...
                // sync_state = row.getAttribute("disabled") == undefined ? true : !row.getAttribute("disabled"); 
                // row.setAttribute("disabled", sync_state); 
