  ...
  if ($uploadOk == 0) {
      ...
      if (move_uploaded_file($_FILES["excel_file"]["tmp_name"], $target_file)) {
          ...
          for ($row = 2; $row <= $highestRow; $row++){
            ...
            $te_id = $re['id']; 
            mysqli_query($con, "insert into supply (suppliers_id, particulars, quantity, debit, credit, date, CustomerCode) values ('$te_id','$rowData[3]','$rowData[4]','$rowData[6]','$rowData[5]','$rowData[0]','$rowData[1]')") or die ("query incorrect"); // 5:credit 6: description 8:date 4: debit  1: suppliers_id
            $index = 0; 
          }
...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_save1'])) {
  ...
  if (mysqli_num_rows($result) == 0) {
    echo "<script>alert('Costomer code and customer name do not match!'); </script>";
    ...
    echo "<script>alert('A new entry added successfully!'); </script>";
    header('Location: add_products.php');
    exit();
  }
}
          ...
          <!-- filter entry main -->     
            ...
            <div class="col-xl-9 col-lg-8">
              <button
                ...
                data-bs-target="#restore-account-modal"
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive ps">
                    <table class="table table-hover tablesorter " id="">
                      <tbody>
                        <?php 
                          $result = mysqli_query($con,"select * from suppliers Order By id DESC") or die ("query 1 incorrect.....");
                          ...
                          {	
                            ...
                            echo "<tr><td>$no</td><td>$tem_name</td><td>$tem_beat</td><td>$amount</td>
                            <td >
