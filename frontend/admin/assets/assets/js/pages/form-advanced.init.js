...
!(function (t) {
  ...
  (e.prototype.initSelect2 = function () {
    ...
    (e.prototype.initSelectize = function () {
      t("#selectize-tags").selectize({
        ...
        t("#selectize-maximum").selectize({ maxItems: 3 }),
        ...
        t("#selectize-optgroup").selectize({ sortField: "text" }),
    ...
    (e.prototype.initMultiSelect = function () {
      0 < t('[data-plugin="multiselect"]').length &&
        t('[data-plugin="multiselect"]').multiSelect(t(this).data());
    }),
  ...
  $(function () {
    var n = $.map(countries, function (e, a) {
    ...
    $.mockjax({
      ...
      response: function (e) {
        var a = e.data.query,
          e = a.toLowerCase(),
          i = new RegExp(
            "\\b" + $.Autocomplete.utils.escapeRegExChars(e),
            "gi"
          ),
          e = $.grep(n, function (e) {
            return i.test(e.value);
          });
        this.responseText = JSON.stringify({ query: a, suggestions: e });
      },
    }),
      $("#autocomplete-ajax").autocomplete({
        ...
        lookupFilter: function (e, a, i) {
          return new RegExp(
            "\\b" + $.Autocomplete.utils.escapeRegExChars(i),
            "gi"
          ).test(e.value);
        },
        onSelect: function (e) {
    ...
    $("#autocomplete").devbridgeAutocomplete({
      ...
      onSelect: function (e) {
        $("#selection").html(
          "You selected: " + e.value + ", " + e.data.category
        );
      },
      ...
      $("#autocomplete-dynamic").autocomplete({ lookup: n });
  });
var countries = {
  AD: "Andorra",
  A2: "Andorra Test",
